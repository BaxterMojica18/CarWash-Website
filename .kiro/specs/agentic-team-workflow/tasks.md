...
- [x] 1. Create the Orchestrator Steering File
  - [x] 1.1 Create `.kiro/steering/orchestrator.md` with frontmatter `inclusion: auto`
...
- [x] 2. Create Hook Configuration Files
  - [x] 2.1 Create `.kiro/hooks/session-context-load.json`
  ...
  - [x] 2.2 Create `.kiro/hooks/doc-update-reminder.json`
  ...
  - [x] 2.3 Create `.kiro/hooks/git-safety-check.json`
  ...
  - [x] 2.4 Create `.kiro/hooks/post-task-qa.json`
  ...
  - [x] 2.5 Create `.kiro/hooks/backend-file-watch.json`
...
- [x] 3. Checkpoint - Verify hook and steering file configuration
...
- [x] 4. Create Role Playbook Files
  - [x] 4.1 Create `.agents/workflows/roles/cto-agent.md`
  ...
  - [x] 4.2 Create `.agents/workflows/roles/backend-agent.md`
  ...
  - [x] 4.3 Create `.agents/workflows/roles/frontend-agent.md`
  ...
  - [x] 4.4 Create `.agents/workflows/roles/qa-agent.md`
...
- [x] 5. Update GIT_BRANCH_GUIDE.md with New Conventions
  - [x] 5.1 Update `GIT_BRANCH_GUIDE.md` to reflect the new git conventions
...
- [x] 6. Update .gitignore to Exclude Reference and Test Files from Deployment
  - [x] 6.1 Add workflow/reference markdown files to `.gitignore`
  ...
  - [x] 6.2 Add pytest/test files to `.gitignore`
    - Add `commands/testing/` directory
    - Add `.pytest_cache/`
    - Add `conftest.py`
    - Add `pytest.ini`
    - Verify existing `test_*.py` pattern is already present (it is)
  - [x] 6.3 Update `.dockerignore` to match the same exclusions
...
- [x] 7. Final Checkpoint - Validate complete configuration
